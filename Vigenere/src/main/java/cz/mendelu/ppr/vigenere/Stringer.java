...
public class Stringer {
    ...
    /**
     * Splits string by characters and adds each one in a particular
     * field of strings. The number of fields is relative to the cutting length
     * and the iterator switches to zero if that index in the string
     * has been reached.
     * 
     * For example string: "abcdefghi" with cut equal to 3 would result
     * in a String array of length 3 with "adg", "beh", "cfi".
     * 
    ...
    /**
     * This method searches string for a delimiter and returns the part before
     * a delimiter occurance. Useful for trimming filename's suffixes.
     * 
     * @param str String to be cut.
    ...
    /**
     * Replaces occurance of all characters with diacritics in a string with
     * the version of the character without one.
     * 
     * @param text Text to be modified.
     * @return Modified string.
     */
